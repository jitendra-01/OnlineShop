...
void ClothingCentre:: MainClothingMenu(){
       int c;
       do{
        cout<<"\n                                   ===========================";
...
void GroceryShop::MainGroceryMenu(){
 int c;
 do{
...
void ElectronicsShop::MainElectronicsMenu(){
    int c;
 do{
    cout<<"\n                                   WELCOME TO GROCERY STORE\n";
    cout<<"                                   ==============================\n";
...
class ShoppingStore:public ClothingCentre,public bookShop,public GroceryShop,public ElectronicsShop{
public:
void menu();
void adminstrator();
void buyer();
...
switch(choice){
    case 1:
    ClothingCentre::MainClothingMenu();
    break;
    case 2:
    bookShop::MainMenu();
    break;
    case 3:
    GroceryShop::MainGroceryMenu();
    break;
    case 4:
    ElectronicsShop::MainElectronicsMenu();
    break;
    case 5:
    cout<<"\nExisting\n";
    break;
